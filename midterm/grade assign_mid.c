...
void grade_iput(student s, char name[], char att[], char ass[], char mid[], char fin[]);

void total_score(student s, float att, float ass, float mid, float fin); // 반영 비율
...
int main()
{
    ...
    for(i = 0; i<SIZE; i++)
    {
        ...
        grade_iput(std[i], name, att, ass, mid, fin);
